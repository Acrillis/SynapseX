...
namespace sxlib.Internal
{
    static class WebInterface
    {
        ...
        [Obfuscation(Feature = "virtualization", Exclude = false)]
        public static string VerifyWebsiteWithVersion(Form This)
        {
            try
            {
                var Request = (HttpWebRequest)WebRequest.Create("https://synapse.to/whitelist/version");
        ...
        [Obfuscation(Feature = "virtualization", Exclude = false)]
        public static string VerifyWebsiteWithVersion()
        {
            try
            {
                var Request = (HttpWebRequest)WebRequest.Create("https://synapse.to/whitelist/version");
        ...
        [Obfuscation(Feature = "virtualization", Exclude = false)]
        public static void VerifyWebsite()
        {
            try
            {
                var Request = (HttpWebRequest)WebRequest.Create("https://synapse.to/whitelist/version");
        ...
        [Obfuscation(Feature = "virtualization", Exclude = false)]
        public static void VerifyWebsite(Form This)
        {
            try
            {
                var Request = (HttpWebRequest)WebRequest.Create("https://synapse.to/whitelist/version");
